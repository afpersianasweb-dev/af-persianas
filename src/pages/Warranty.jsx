        ...
        <Section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                ...
                >
                    ...
                    <h2 className="text-xl font-bold mb-3">Mecanismos</h2>
                ...
                >
                    ...
                    <h2 className="text-xl font-bold mb-3">Tejidos</h2>
                    <p className="text-neutral-600">
                ...
                >
                    ...
                    <h2 className="text-xl font-bold mb-3">Instalación</h2>
                    <p className="text-neutral-600">
            ...
            <div className="bg-neutral-50 p-6 md:p-8 rounded-2xl flex flex-col md:flex-row items-start gap-6 max-w-4xl mx-auto">
                ...
                <div>
                    <h2 className="text-xl font-bold mb-2">Requisitos para validación</h2>
